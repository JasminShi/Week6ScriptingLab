...
[System.Serializable]
public class AngleSliderUpdateEvent : UnityEvent<float>
{ }

public class AngleInteractable : XRBaseInteractable
{
    ...
    //public void AngleInteractableAmount(float t)
    //{
    //    transform.rotation = Quaternion.Slerp(start.rotation, end.rotation, t);
    //}

    public AngleInteractableSliderUpdateEvent sliderUpdate = new AngleInteractableSliderUpdateEvent();
    ...
    IEnumerator CalculateDrag()
    {
        ...
        while (interactor != null)
        {
            ...
            float percent = Mathf.InverseLerp(start.position, end.position, orthoProjection);
...
//#if UNITY_EDITOR
//public class AngleInteractableGizmoDrawer
//    {
